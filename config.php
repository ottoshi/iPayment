...
function fn_IPAYMENTPROM_config() {
	...
	if (isset($_POST['update'])) {
		delete_option('_iPAYMENT_PROMP_IDCARD');
		delete_option('_iPAYMENT_PROMP_PHONE');
		...
		add_option( '_iPAYMENT_PROMP_IDCARD', $_POST["ipayment_promp_idcard"] );
		add_option( '_iPAYMENT_PROMP_PHONE', $_POST["ipayment_promp_phone"] );
  ...
  ?>
    ...
    <div class="wrap">
        ...
        <h2>Config Omise</h2>        		
		<?php
		$ipayment_promp_idcard =  get_option( '_iPAYMENT_PROMP_IDCARD' ,'');
		$ipayment_promp_phone =  get_option( '_iPAYMENT_PROMP_PHONE' ,'');	
		...
		?>
			...
			<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                <table class='wp-list-table widefat fixed'>
					<tr><th>Prompay ID Card</th><td><input size='50' type="text" name="ipayment_promp_idcard" value="<?php echo $ipayment_promp_idcard; ?>"/</td></tr>
					<tr><th>Prompay Phone number</th><td><input size='50' type="text" name="ipayment_promp_phone" value="<?php echo $ipayment_promp_phone; ?>"/></td></tr>
